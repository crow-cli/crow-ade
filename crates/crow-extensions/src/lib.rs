//! Extension host management for `Crow` — Node.js extension host + WASM
//! extensions.
//!
//! This crate provides:
//!
...
//!   `Crow` WASM `crow.toml` manifests, build init-data payloads.
...
pub use paths::{
    global_storage_dir, resolve_node_runtime, crow_data_dir, user_data_dir, user_extensions_dir,
    NodeRuntime,
};
pub use protocol::{
