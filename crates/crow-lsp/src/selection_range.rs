...
impl SelectionRange {
    ...
    pub fn all_ranges(&self) -> Vec<crow_text::Range> {
    ...
    fn selection_range_serde() {
        let range = SelectionRange {
            range: crow_text::Range::new(
                crow_text::Position::new(5, 4),
                crow_text::Position::new(5, 10),
            ),
            parent: Some(Box::new(SelectionRange {
                range: crow_text::Range::new(
                    crow_text::Position::new(5, 0),
                    crow_text::Position::new(5, 30),
                ),
                parent: None,
            })),
        };
