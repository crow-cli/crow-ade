...
pub struct CallHierarchyItemInfo {
    ...
    pub selection_range: crow_text::Range,
...
pub struct IncomingCall {
    ...
    pub from_ranges: Vec<crow_text::Range>,
}
...
mod tests {
    ...
    fn call_hierarchy_item_info_serde() {
        let info = CallHierarchyItemInfo {
            ...
            range: crow_text::Range::new(
                ...
                crow_text::Position::new(5, 1),
            ),
            selection_range: crow_text::Range::new(
                crow_text::Position::new(0, 3),
                crow_text::Position::new(0, 7),
            ),
    ...
    fn call_hierarchy_item_symbol_kind() {
        let info = CallHierarchyItemInfo {
            ...
            uri: "file:///t.rs".into(),
            range: crow_text::Range::new(crow_text::Position::ZERO, crow_text::Position::ZERO),
            selection_range: crow_text::Range::new(
    ...
    fn incoming_call_serde() {
        let call = IncomingCall {
            from: CallHierarchyItemInfo {
                ...
                uri: "file:///a.rs".into(),
                range: crow_text::Range::new(
                    crow_text::Position::new(10, 0),
                    crow_text::Position::new(20, 1),
                ),
                selection_range: crow_text::Range::new(
                    crow_text::Position::new(10, 3),
                    crow_text::Position::new(10, 9),
                ),
                detail: None,
                raw: None,
            },
            from_ranges: vec![crow_text::Range::new(
                crow_text::Position::new(15, 4),
                crow_text::Position::new(15, 10),
            )],
        };
    ...
    fn outgoing_call_serde() {
        let call = OutgoingCall {
            to: CallHierarchyItemInfo {
                ...
                range: crow_text::Range::new(
                    crow_text::Position::new(0, 0),
                    crow_text::Position::new(3, 1),
                ),
                selection_range: crow_text::Range::new(
                    crow_text::Position::new(0, 3),
                    crow_text::Position::new(0, 9),
                ),
                detail: None,
                raw: None,
            },
