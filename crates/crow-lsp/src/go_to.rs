...
pub struct NavigationEntry {
    pub uri: String,
    pub position: crow_text::Position,
...
impl NavigationHistory {
    ...
    pub fn push(&mut self, uri: String, position: crow_text::Position) {
    ...
    pub fn go_back(
        &mut self,
        current_uri: &str,
        current_pos: crow_text::Position,
...
impl GoToService {
    ...
    pub fn go_back(
        ...
        current_uri: &str,
        current_pos: crow_text::Position,
    ) -> Option<(String, crow_text::Position)> {
        self.history
...
mod tests {
    ...
    fn location_serialize() {
        let loc = Location {
            ...
            range: crow_text::Range::new(
                crow_text::Position::new(1, 2),
                crow_text::Position::new(3, 4),
            ),
        };
    ...
    fn navigation_history_push_and_back() {
        ...
        history.push("file:///a.rs".into(), crow_text::Position::new(1, 0));
        history.push("file:///b.rs".into(), crow_text::Position::new(5, 0));

        assert!(history.can_go_back());
        assert!(!history.can_go_forward());

        let entry = history
            .go_back("file:///c.rs", crow_text::Position::new(10, 0))
            .unwrap();
    ...
    fn navigation_history_forward() {
        let mut history = NavigationHistory::new(10);
        history.push("file:///a.rs".into(), crow_text::Position::new(1, 0));
        history.go_back("file:///b.rs", crow_text::Position::new(2, 0));

        let entry = history
            .go_forward("file:///b.rs", crow_text::Position::new(2, 0))
            .unwrap();
    ...
    fn navigation_history_push_clears_forward() {
        ...
        history.go_back("file:///b.rs", crow_text::Position::new(2, 0));
        assert!(history.can_go_forward());
        history.push("file:///c.rs".into(), crow_text::Position::new(3, 0));
        assert!(!history.can_go_forward());
    }
    ...
    fn navigation_history_max_size() {
        ...
        for i in 0..5 {
            history.push(format!("file:///{i}.rs"), crow_text::Position::new(i, 0));
        }
    ...
    fn navigation_history_clear() {
        let mut history = NavigationHistory::new(10);
        history.push("file:///a.rs".into(), crow_text::Position::ZERO);
        history.clear();
        assert!(!history.can_go_back());
        assert!(!history.can_go_forward());
    }
    ...
    fn resolve_single_one_location() {
        let locs = vec![Location {
            uri: "file:///a.rs".into(),
            range: crow_text::Range::new(
                crow_text::Position::new(0, 0),
                crow_text::Position::new(0, 5),
            ),
        }];
