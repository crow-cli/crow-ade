...
const isTauri = !!(globalThis as any).__CROW_TAURI__;
...
export class TextMateTokenizationFeature extends Disposable implements ITextMateTokenizationService {
	...
	constructor(
		...
		this._logService.info('[Crow-TextMate] TextMateTokenizationFeature constructed');
		grammarsExtPoint.setHandler(extensions => {
			this._logService.info(
				`[Crow-TextMate] grammarsExtPoint delivered ${extensions.length} extension(s) with grammars`
			);
