...
export const extensionDefaultIcon = registerIcon(
	...
	Codicon.extensionsLarge,
	localize('extensionDefault', 'Icon used for the default extension in the extensions view and editor.')
);
export const verifiedPublisherIcon = registerIcon(
	'extensions-verified-publisher',
	Codicon.verifiedFilled,
	localize('verifiedPublisher', 'Icon used for the verified extension publisher in the extensions view and editor.')
);
export const extensionVerifiedPublisherIconColor = registerColor(
	'extensionIcon.verifiedForeground',
	textLinkForeground,
	localize('extensionIconVerifiedForeground', 'The icon color for extension verified publisher.'),
	false
);
