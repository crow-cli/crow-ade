...
export const COLOR_THEME_CROW_MONO_INITIAL_COLORS: Record<string, string> = {
...
export const CROW_PURPLE_INITIAL_COLORS = {
	...
	'editorWarning.foreground': '#39FF14',
