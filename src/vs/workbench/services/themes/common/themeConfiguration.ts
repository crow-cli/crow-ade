...
const colorThemeSettingSchema: IConfigurationPropertySchema = {
	...
	markdownDescription: nls.localize(
		{ key: 'colorTheme', comment: ['{0} will become a link to another setting.'] },
...
export class ThemeConfiguration {
	...
	public get tokenColorCustomizations(): ITokenColorCustomizations {
		const tokenColorCustomization =
			this.configurationService.getValue<ITokenColorCustomizations>(ThemeSettings.TOKEN_COLOR_CUSTOMIZATIONS) || {};
