/*---------------------------------------------------------------------------------------------
 *  Crow - A fast, native code editor
...
// Crow: Register null stubs for stripped services (must be early)
import './crowNullServices.js';

// Crow: Register Rust-backed bridge services as DI singletons
import '../platform/crow/browser/crowFileSystemProvider.js';
import '../platform/crow/browser/crowSearchProvider.js';
import '../platform/crow/browser/crowSCMProvider.js';
import '../platform/crow/browser/crowSyntaxService.js';
import '../platform/crow/browser/crowLspService.js';
import '../platform/crow/browser/crowDapService.js';
import '../platform/crow/browser/crowRemoteService.js';
import '../platform/crow/common/crowThemeService.js';
import '../platform/crow/common/crowSettingsService.js';
import '../platform/crow/common/crowKeymapService.js';
