...
export const STATUS_BAR_REMOTE_ITEM_BACKGROUND = registerColor(
	...
	ACTIVITY_BAR_BADGE_BACKGROUND,
	localize('statusBarItemRemoteBackground', 'Background color for the remote indicator on the status bar.')
);

export const STATUS_BAR_REMOTE_ITEM_FOREGROUND = registerColor(
	'statusBarItem.remoteForeground',
	ACTIVITY_BAR_BADGE_FOREGROUND,
	localize('statusBarItemRemoteForeground', 'Foreground color for the remote indicator on the status bar.')
);
