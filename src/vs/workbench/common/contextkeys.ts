...
export const ActiveCrowContext = new RawContextKey<string>(
	'activeCrow',
	'',
	localize('activeCrow', 'The identifier of the active Crow panel')
);
export const CrowFocusContext = new RawContextKey<boolean>(
	'crowFocus',
	false,
	localize('crowFocus', 'Whether the Crow panel has keyboard focus')
);
