...
export class WorkbenchContextKeysHandler extends Disposable {
	...
	constructor(
		...
		// Capabilities
		// Crow: running in Tauri — there is no browser File System Access API.
		...
		this.openFolderWorkspaceSupportContext.set(
			isNative || !!(globalThis as any).__CROW_TAURI__ || typeof this.environmentService.remoteAuthority === 'string'
		);
