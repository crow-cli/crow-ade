	...
	return verifyObject<IEditorPartOptions>(
		{
			...
			preventPinnedEditorClose: new EnumVerifier(DEFAULT_EDITOR_PART_OPTIONS['preventPinnedEditorClose'], [
				'keyboardAndMouse',
				'keyboard',
				'mouse',
				'never'
			...
			titleScrollbarVisibility: new EnumVerifier(DEFAULT_EDITOR_PART_OPTIONS['titleScrollbarVisibility'], [
				'auto',
				'visible',
				'hidden'
			]),
			...
			openSideBySideDirection: new EnumVerifier(DEFAULT_EDITOR_PART_OPTIONS['openSideBySideDirection'], [
				'right',
				'down'
			]),
			...
			editorActionsLocation: new EnumVerifier(DEFAULT_EDITOR_PART_OPTIONS['editorActionsLocation'], [
				'default',
				'titleBar',
				'hidden'
			]),
