...
import { CrowPart } from './crow/crowPart.js';
...
export class PaneCompositePartService extends Disposable implements IPaneCompositePartService {
	...
	constructor(@IInstantiationService instantiationService: IInstantiationService) {
		...
		const crowPart = instantiationService.createInstance(CrowPart);
		...
		this.paneCompositeParts.set(ViewContainerLocation.Crow, crowPart);
