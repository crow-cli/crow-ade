...
export const TERMINAL_SYMBOL_ICON_COMMIT_FOREGROUND = registerColor(
...
export const TERMINAL_SYMBOL_ICON_BRANCH_FOREGROUND = registerColor(
...
export const TERMINAL_SYMBOL_ICON_TAG_FOREGROUND = registerColor(
...
export const TERMINAL_SYMBOL_ICON_STASH_FOREGROUND = registerColor(
...
export const TERMINAL_SYMBOL_ICON_REMOTE_FOREGROUND = registerColor(
...
export const TERMINAL_SYMBOL_ICON_PULL_REQUEST_FOREGROUND = registerColor(
...
export const TERMINAL_SYMBOL_ICON_PULL_REQUEST_DONE_FOREGROUND = registerColor(
...
export const terminalSymbolFlagIcon = registerIcon(
	...
	Codicon.flag,
	localize('terminalSymbolFlagIcon', 'Icon for flags in the terminal suggest widget.'),
...
export const terminalSymbolAliasIcon = registerIcon(
	...
	localize('terminalSymbolAliasIcon', 'Icon for aliases in the terminal suggest widget.'),
...
export const terminalSymbolEnumMember = registerIcon(
	...
	localize('terminalSymbolOptionValue', 'Icon for enum members in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_OPTION_VALUE_FOREGROUND
);
export const terminalSymbolMethodIcon = registerIcon(
	'terminal-symbol-method',
	Codicon.symbolMethod,
	localize('terminalSymbolMethodIcon', 'Icon for methods in the terminal suggest widget.'),
...
export const terminalSymbolArgumentIcon = registerIcon(
	...
	localize('terminalSymbolArgumentIcon', 'Icon for arguments in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_ARGUMENT_FOREGROUND
);
export const terminalSymbolOptionIcon = registerIcon(
	'terminal-symbol-option',
	Codicon.symbolEnum,
	localize('terminalSymbolOptionIcon', 'Icon for options in the terminal suggest widget.'),
...
export const terminalSymbolInlineSuggestionIcon = registerIcon(
	...
	Codicon.star,
	localize('terminalSymbolInlineSuggestionIcon', 'Icon for inline suggestions in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_INLINE_SUGGESTION_FOREGROUND
);
export const terminalSymbolFileIcon = registerIcon(
	'terminal-symbol-file',
	Codicon.symbolFile,
	localize('terminalSymbolFileIcon', 'Icon for files in the terminal suggest widget.'),
...
export const terminalSymbolFolderIcon = registerIcon(
	...
	localize('terminalSymbolFolderIcon', 'Icon for folders in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_FOLDER_FOREGROUND
);

export const terminalSymbolCommitIcon = registerIcon(
	'terminal-symbol-commit',
	Codicon.gitCommit,
	localize('terminalSymbolCommitIcon', 'Icon for commits in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_COMMIT_FOREGROUND
);
export const terminalSymbolBranchIcon = registerIcon(
	'terminal-symbol-branch',
	Codicon.gitBranch,
	localize('terminalSymbolBranchIcon', 'Icon for branches in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_BRANCH_FOREGROUND
);
export const terminalSymbolTagIcon = registerIcon(
	'terminal-symbol-tag',
	Codicon.tag,
	localize('terminalSymbolTagIcon', 'Icon for tags in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_TAG_FOREGROUND
);
export const terminalSymbolStashIcon = registerIcon(
	'terminal-symbol-stash',
	Codicon.gitStash,
	localize('terminalSymbolStashIcon', 'Icon for stashes in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_STASH_FOREGROUND
);
export const terminalSymbolRemoteIcon = registerIcon(
	'terminal-symbol-remote',
	Codicon.remote,
	localize('terminalSymbolRemoteIcon', 'Icon for remotes in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_REMOTE_FOREGROUND
);
export const terminalSymbolPullRequestIcon = registerIcon(
	'terminal-symbol-pull-request',
	Codicon.gitPullRequest,
	localize('terminalSymbolPullRequestIcon', 'Icon for pull requests in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_PULL_REQUEST_FOREGROUND
);
export const terminalSymbolPullRequestDoneIcon = registerIcon(
	'terminal-symbol-pull-request-done',
	Codicon.gitPullRequestDone,
	localize('terminalSymbolPullRequestDoneIcon', 'Icon for completed pull requests in the terminal suggest widget.'),
...
export const terminalSymbolSymbolicLinkFileIcon = registerIcon(
	...
	localize('terminalSymbolSymbolicLinkFileIcon', 'Icon for symbolic link files in the terminal suggest widget.'),
...
export const terminalSymbolSymbolicLinkFolderIcon = registerIcon(
	...
	localize('terminalSymbolSymbolicLinkFolderIcon', 'Icon for symbolic link folders in the terminal suggest widget.'),
	TERMINAL_SYMBOL_ICON_SYMBOLIC_LINK_FOLDER_FOREGROUND
);

export const terminalSymbolSymbolTextIcon = registerIcon(
	'terminal-symbol-symbol-text',
	Codicon.symbolKey,
	localize('terminalSymbolSymboTextIcon', 'Icon for plain text suggestions in the terminal suggest widget.'),
