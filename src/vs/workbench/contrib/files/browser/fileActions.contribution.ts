...
appendSaveConflictEditorTitleAction(
	...
	nls.localize('acceptLocalChanges', 'Use your changes and overwrite file contents'),
	Codicon.check,
	-10,
	acceptLocalChangesCommand
);
appendSaveConflictEditorTitleAction(
	...
	nls.localize('revertLocalChanges', 'Discard your changes and revert to file contents'),
	Codicon.discard,
	-9,
	revertLocalChangesCommand
);
