...
export default class Messages {
	...
	public static PROBLEMS_PANEL_CONFIGURATION_SHOW_CURRENT_STATUS: string = nls.localize(
		'problems.panel.configuration.showCurrentInStatus',
		'When enabled shows the current problem in the status bar.'
	);
	public static PROBLEMS_PANEL_CONFIGURATION_COMPARE_ORDER: string = nls.localize(
		'problems.panel.configuration.compareOrder',
		'Controls the order in which problems are navigated.'
	);
	public static PROBLEMS_PANEL_CONFIGURATION_COMPARE_ORDER_SEVERITY: string = nls.localize(
		'problems.panel.configuration.compareOrder.severity',
		'Navigate problems ordered by severity'
	);
	public static PROBLEMS_PANEL_CONFIGURATION_COMPARE_ORDER_POSITION: string = nls.localize(
	...
	public static MARKERS_PANEL_NO_PROBLEMS_ACTIVE_FILE_BUILT: string = nls.localize(
	...
	public static MARKERS_PANEL_ACTION_TOOLTIP_MORE_FILTERS: string = nls.localize(
	...
	public static MARKERS_PANEL_FILTER_LABEL_EXCLUDED_FILES: string = nls.localize(
