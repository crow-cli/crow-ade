...
export namespace TestingContextKeys {
	...
	export const isContinuousModeOn = new RawContextKey<boolean>('testing.isContinuousModeOn', false, {
		type: 'boolean',
	...
	export const hasCoverageInFile = new RawContextKey('testing.hasCoverageInFile', false, {
		type: 'boolean',
		description: localize('testing.hasCoverageInFile', 'Indicates coverage has been reported in the curent editor.')
	});
	...
	export const hasInlineCoverageDetails = new RawContextKey('testing.hasInlineCoverageDetails', false, {
		type: 'boolean',
		description: localize(
