...
class SCMAccessibilityHelpContentProvider extends Disposable implements IAccessibleViewContentProvider {
	...
	provideContent(): string {
		...
		content.push(
			localize('scm-repositories-msg4', ' - Use the up/down arrow keys to navigate the list of repositories.')
		);
		...
		content.push(
			localize('scm-graph-msg5', ' - Use the Space key to open the history item details in the multi-file diff editor.')
		);
