/*---------------------------------------------------------------------------------------------
 *  Crow Task Service
 *  Bridges VS Code's task runner to the Rust `crow-tasks` crate via Tauri IPC.
 *
...
export const ICrowTaskService = createDecorator<ICrowTaskService>('crowTaskService');

export interface ICrowTaskService extends CrowTaskService {
	readonly _serviceBrand: undefined;
}

// ── Service implementation ─────────────────────────────────────────────────────

export class CrowTaskService {
...
registerSingleton(ICrowTaskService, CrowTaskService, InstantiationType.Delayed);
