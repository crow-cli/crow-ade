/*---------------------------------------------------------------------------------------------
 *  Crow Settings Service
 *  Routes settings read/write through the Rust `crow-settings` crate.
 *
...
export const ICrowSettingsService = createDecorator<ICrowSettingsService>('crowSettingsService');

export interface ICrowSettingsService extends CrowSettingsService {
	readonly _serviceBrand: undefined;
}

export class CrowSettingsService {
...
registerSingleton(ICrowSettingsService, CrowSettingsService, InstantiationType.Delayed);
