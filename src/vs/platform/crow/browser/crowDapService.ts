/*---------------------------------------------------------------------------------------------
 *  Crow DAP Service
 *  Thin wrapper around the Rust `crow-dap` crate via Tauri IPC. Exposes the
...
export const ICrowDapService = createDecorator<ICrowDapService>('crowDapService');

export interface ICrowDapService extends CrowDapService {
	readonly _serviceBrand: undefined;
}

export class CrowDapService {
...
registerSingleton(ICrowDapService, CrowDapService, InstantiationType.Delayed);
