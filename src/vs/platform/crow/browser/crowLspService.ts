/*---------------------------------------------------------------------------------------------
 *  Crow LSP Service
 *  Thin wrapper around the Rust `crow-lsp` crate via Tauri IPC. Spawns
...
export const ICrowLspService = createDecorator<ICrowLspService>('crowLspService');

export interface ICrowLspService extends CrowLspService {
	readonly _serviceBrand: undefined;
}

export class CrowLspService {
...
registerSingleton(ICrowLspService, CrowLspService, InstantiationType.Delayed);
