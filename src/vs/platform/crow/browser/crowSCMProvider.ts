 ...
 *  `crow-git` crate via Tauri IPC, intended for consumers that need a
...
export const ICrowSCMProviderService = createDecorator<ICrowSCMProviderService>('crowSCMProviderService');

export interface ICrowSCMProviderService extends CrowSCMProvider {
	readonly _serviceBrand: undefined;
}

export class CrowSCMProvider {
...
registerSingleton(ICrowSCMProviderService, CrowSCMProvider, InstantiationType.Delayed);
