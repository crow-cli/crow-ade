...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			...
			dataFolderName: '.crow',
			urlProtocol: 'crow',
			reportIssueUrl: 'https://github.com/Razshy/crowvs/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/Razshy/crowvs/blob/main/LICENSE',
			serverLicenseUrl: 'https://github.com/Razshy/crowvs/blob/main/LICENSE',
			extensionsGallery: {
