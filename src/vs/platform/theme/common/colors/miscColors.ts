...
export const activityWarningBadgeForeground = registerColor(
...
export const activityWarningBadgeBackground = registerColor(
...
export const activityErrorBadgeForeground = registerColor(
...
export const activityErrorBadgeBackground = registerColor(
...
export const scrollbarBackground = registerColor(
...
export const chartGuide = registerColor(
	'chart.guide',
	{
