...
export function registerOpenEditorListeners(
	element: HTMLElement,
	onOpenEditor: (options: IOpenEditorOptions) => void
): IDisposable {
	...
	disposables.add(
		addDisposableListener(element, EventType.KEY_DOWN, e => {
...
export function toOpenEditorOptions(
	event: StandardMouseEvent | StandardKeyboardEvent,
	isDoubleClick?: boolean
): IOpenEditorOptions | undefined {
