...
const CURRENT_TARGET_PLATFORM =
	isWeb && !(globalThis as any).__CROW_TAURI__ ? TargetPlatform.WEB : getTargetPlatform(platform, arch);
...
export abstract class AbstractExtensionGalleryService implements IExtensionGalleryService {
	...
	/**
	 * Crow: short-lived cache of marketplace endpoints that recently
