	...
	return (function (e) {
		...
		function (e, r, t) {
			(function (t) {
				...
				((r = e.exports = H),
					(n =
						'object' == typeof t && t.env && t.env.NODE_DEBUG && /\bsemver\b/i.test(t.env.NODE_DEBUG)
							? function () {
				...
				((r.parse = F),
					...
					(H.prototype.compareMain = function (e) {
						return (
							e instanceof H || (e = new H(e, this.loose)),
							K(this.major, e.major) || K(this.minor, e.minor) || K(this.patch, e.patch)
						);
					}),
					(H.prototype.comparePre = function (e) {
						if ((e instanceof H || (e = new H(e, this.loose)), this.prerelease.length && !e.prerelease.length))
							return -1;
						...
						do {
							var t = this.prerelease[r],
								o = e.prerelease[r];
							if ((n('prerelease compare', r, t, o), void 0 === t && void 0 === o)) return 0;
					...
					(r.diff = function (e, r) {
						...
						if (t.prerelease.length || n.prerelease.length) {
							for (var o in t) if (('major' === o || 'minor' === o || 'patch' === o) && t[o] !== n[o]) return 'pre' + o;
							return 'prerelease';
						}
						for (var o in t) if (('major' === o || 'minor' === o || 'patch' === o) && t[o] !== n[o]) return o;
					}),
				...
				function K(e, r) {
					var t = J.test(e),
						n = J.test(r);
					return (t && n && ((e = +e), (r = +r)), t && !n ? -1 : n && !t ? 1 : e < r ? -1 : e > r ? 1 : 0);
				}
				function Q(e, r, t) {
				...
				function oe(e, r, t, n) {
					...
					switch (r) {
						case '===':
							('object' == typeof e && (e = e.version), 'object' == typeof t && (t = t.version), (o = e === t));
							break;
						case '!==':
							('object' == typeof e && (e = e.version), 'object' == typeof t && (t = t.version), (o = e !== t));
							break;
				...
				function ie(e, r) {
					...
					(n('comparator', e, r),
						(this.loose = r),
						this.parse(e),
						this.semver === se ? (this.value = '') : (this.value = this.operator + this.semver.version),
						n('comp', this));
				}
				...
				function ce(e, r, t, n, o, i, s, a, u, c, p, f, l) {
					return (
						(r = ue(t) ? '' : ue(n) ? '>=' + t + '.0.0' : ue(o) ? '>=' + t + '.' + n + '.0' : '>=' + r) +
						' ' +
						(a = ue(u)
							? ''
							: ue(c)
				...
				function pe(e, r) {
					...
					if (r.prerelease.length) {
						for (t = 0; t < e.length; t++)
							if ((n(e[t].semver), e[t].semver !== se && e[t].semver.prerelease.length > 0)) {
								var o = e[t].semver;
								if (o.major === r.major && o.minor === r.minor && o.patch === r.patch) return !0;
							}
						return !1;
					}
					return !0;
						...
						if (
							(p.forEach(function (e) {
								(e.semver === se && (e = new ie('>=0.0.0')),
									(f = f || e),
									(l = l || e),
									o(e.semver, f.semver, n) ? (f = e) : s(e.semver, l.semver, n) && (l = e));
							}),
				...
				((ie.prototype.parse = function (e) {
					...
					(ie.prototype.test = function (e) {
						return (
							...
							this.semver === se ||
								('string' == typeof e && (e = new H(e, this.loose)), oe(e, this.operator, this.semver, this.loose))
						);
					}),
					(ie.prototype.intersects = function (e, r) {
						if (!(e instanceof ie)) throw new TypeError('a Comparator is required');
						var t;
						if ('' === this.operator) return ((t = new ae(e.value, r)), fe(this.value, t, r));
						if ('' === e.operator) return ((t = new ae(this.value, r)), fe(e.semver, t, r));
					...
					(ae.prototype.parseRange = function (e) {
						...
						((e = e.replace(t, ce)),
							...
							(e = (e = (e = e.replace(s[M], '$1~')).replace(s[L], '$1^')).split(/\s+/).join(' ')));
						var o = r ? s[D] : s[X],
							i = e
								.split(' ')
								.map(function (e) {
									return (function (e, r) {
										return (
													...
													e
														...
														.map(function (e) {
															return (function (e, r) {
																e = e.trim();
																var t = r ? s[_] : s[I];
																return e.replace(t, function (r, t, o, i, s, a) {
											...
											n('xrange', e),
											(e = (function (e, r) {
												return (n('replaceStars', e, r), e.trim().replace(s[B], ''));
											})(e, r)),
											n('stars', e),
											e
										);
					...
					(ae.prototype.test = function (e) {
						...
						for (var r = 0; r < this.set.length; r++) if (pe(this.set[r], e)) return !0;
						return !1;
					}),
					(r.satisfies = fe),
					(r.maxSatisfying = function (e, r, t) {
						...
						return (
							e.forEach(function (e) {
								i.test(e) && ((n && -1 !== o.compare(e)) || (o = new H((n = e), t)));
							}),
							n
						);
					}),
					...
					(r.coerce = function (e) {
						...
						if ('string' != typeof e) return null;
						var r = e.match(s[O]);
						return null == r ? null : F((r[1] || '0') + '.' + (r[2] || '0') + '.' + (r[3] || '0'));
					}));
			}).call(this, t(1));
		},
		function (e, r) {
