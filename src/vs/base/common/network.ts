...
export namespace Schemas {
	...
	/** Scheme used for Crow markdown preview editor tabs. */
	export const markdownPreview = 'crow-markdown-preview';
...
class FileAccessImpl {
	...
	uriToBrowserUri(uri: URI): URI {
		...
		if (uri.scheme === Schemas.file && (globalThis as any).__CROW_TAURI__) {
			const encoded = encodeURIComponent(uri.fsPath);
			return URI.parse(`crow-asset://localhost/${encoded}`);
		}
