...
export class InlineEditsCollapsedView extends Disposable implements IInlineEditsView {
	...
	constructor(
		...
		const startPosition = firstEdit.map(edit =>
			edit ? singleTextRemoveCommonPrefix(edit, this._editor.getModel()!).range.getStartPosition() : null
		);
