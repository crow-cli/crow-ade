...
export const Context = {
	...
	DetailsFocused: new RawContextKey<boolean>(
		'suggestWidgetDetailsFocused',
		false,
		localize('suggestWidgetDetailsFocused', 'Whether the details pane of the suggest widget has focus')
	),
	MultipleSuggestions: new RawContextKey<boolean>(
		'suggestWidgetMultipleSuggestions',
		false,
		localize('suggestWidgetMultipleSuggestions', 'Whether there are multiple suggestions to pick from')
	),
	...
	HasInsertAndReplaceRange: new RawContextKey<boolean>(
		...
		false,
		localize('suggestionHasInsertAndReplaceRange', 'Whether the current suggestion has insert and replace behaviour')
	),
	...
	CanResolve: new RawContextKey<boolean>(
		...
		false,
		localize('suggestionCanResolve', 'Whether the current suggestion supports to resolve further details')
	)
};
...
export class CompletionOptions {
	...
	constructor(
		...
		readonly providerItemsToReuse: ReadonlyMap<languages.CompletionItemProvider, CompletionItem[]> = new Map<
