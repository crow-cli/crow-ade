...
export class ColorPickerHeader extends Disposable {
	...
	constructor(
		...
		private type: ColorPickerWidgetType
	) {
		super();
		...
		this._register(
			dom.addDisposableListener(this._pickedColorNode, dom.EventType.CLICK, () =>
				this.model.selectNextColorPresentation()
			)
		);
		this._register(
			dom.addDisposableListener(this._originalColorNode, dom.EventType.CLICK, () => {
