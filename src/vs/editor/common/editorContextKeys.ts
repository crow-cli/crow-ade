...
export namespace EditorContextKeys {
	...
	export const editorTextFocus = new RawContextKey<boolean>(
		'editorTextFocus',
		false,
		nls.localize('editorTextFocus', 'Whether the editor text has focus (cursor is blinking)')
	);
	/**
	...
	export const focus = new RawContextKey<boolean>(
		'editorFocus',
		false,
		nls.localize('editorFocus', 'Whether the editor or an editor widget has focus (e.g. focus is in the find widget)')
	);
	...
	export const textInputFocus = new RawContextKey<boolean>(
		'textInputFocus',
		false,
		nls.localize('textInputFocus', 'Whether an editor or a rich text input has focus (cursor is blinking)')
	);
	...
	export const isEmbeddedDiffEditor = new RawContextKey<boolean>(
		...
		false,
		nls.localize('isEmbeddedDiffEditor', 'Whether the context is an embedded diff editor')
	);
	export const inMultiDiffEditor = new RawContextKey<boolean>(
		'inMultiDiffEditor',
		false,
		nls.localize('inMultiDiffEditor', 'Whether the context is a multi diff editor')
	);
	export const multiDiffEditorAllCollapsed = new RawContextKey<boolean>(
		'multiDiffEditorAllCollapsed',
		undefined,
		nls.localize('multiDiffEditorAllCollapsed', 'Whether all files in multi diff editor are collapsed')
	);
	...
	export const comparingMovedCode = new RawContextKey<boolean>(
		'comparingMovedCode',
		false,
		nls.localize('comparingMovedCode', 'Whether a moved code block is selected for comparison')
	);
	export const accessibleDiffViewerVisible = new RawContextKey<boolean>(
		'accessibleDiffViewerVisible',
		false,
		nls.localize('accessibleDiffViewerVisible', 'Whether the accessible diff viewer is visible')
	);
	...
	export const diffEditorOriginalWritable = new RawContextKey<boolean>(
		...
		false,
		nls.localize('diffEditorOriginalWritable', 'Whether modified is writable in the diff editor')
	);
	export const diffEditorModifiedWritable = new RawContextKey<boolean>(
		'diffEditorModifiedWritable',
		false,
		nls.localize('diffEditorModifiedWritable', 'Whether modified is writable in the diff editor')
	);
	...
	export const columnSelection = new RawContextKey<boolean>(
		...
		false,
		nls.localize('editorColumnSelection', 'Whether `editor.columnSelection` is enabled')
	);
	...
	export const hasMultipleSelections = new RawContextKey<boolean>(
		...
		false,
		nls.localize('editorHasMultipleSelections', 'Whether the editor has multiple selections')
	);
	export const hasSingleSelection = hasMultipleSelections.toNegated();
	export const tabMovesFocus = new RawContextKey<boolean>(
		'editorTabMovesFocus',
		false,
		nls.localize('editorTabMovesFocus', 'Whether `Tab` will move focus out of the editor')
	);
	...
	export const standaloneColorPickerVisible = new RawContextKey<boolean>(
		...
		false,
		nls.localize('standaloneColorPickerVisible', 'Whether the standalone color picker is visible')
	);
	export const standaloneColorPickerFocused = new RawContextKey<boolean>(
		'standaloneColorPickerFocused',
		false,
		nls.localize('standaloneColorPickerFocused', 'Whether the standalone color picker is focused')
	);
	...
	export const inCompositeEditor = new RawContextKey<boolean>(
		'inCompositeEditor',
		undefined,
		nls.localize('inCompositeEditor', 'Whether the editor is part of a larger editor (e.g. notebooks)')
	);
	...
	export const hasCompletionItemProvider = new RawContextKey<boolean>(
		...
		false,
		nls.localize('editorHasCompletionItemProvider', 'Whether the editor has a completion item provider')
	);
	export const hasCodeActionsProvider = new RawContextKey<boolean>(
		'editorHasCodeActionsProvider',
		false,
		nls.localize('editorHasCodeActionsProvider', 'Whether the editor has a code actions provider')
	);
	export const hasCodeLensProvider = new RawContextKey<boolean>(
		'editorHasCodeLensProvider',
		false,
		nls.localize('editorHasCodeLensProvider', 'Whether the editor has a code lens provider')
	);
	export const hasDefinitionProvider = new RawContextKey<boolean>(
		'editorHasDefinitionProvider',
		false,
		nls.localize('editorHasDefinitionProvider', 'Whether the editor has a definition provider')
	);
	export const hasDeclarationProvider = new RawContextKey<boolean>(
		'editorHasDeclarationProvider',
		false,
		nls.localize('editorHasDeclarationProvider', 'Whether the editor has a declaration provider')
	);
	export const hasImplementationProvider = new RawContextKey<boolean>(
		'editorHasImplementationProvider',
		false,
		nls.localize('editorHasImplementationProvider', 'Whether the editor has an implementation provider')
	);
	export const hasTypeDefinitionProvider = new RawContextKey<boolean>(
		'editorHasTypeDefinitionProvider',
		false,
		nls.localize('editorHasTypeDefinitionProvider', 'Whether the editor has a type definition provider')
	);
	export const hasHoverProvider = new RawContextKey<boolean>(
		'editorHasHoverProvider',
		false,
		nls.localize('editorHasHoverProvider', 'Whether the editor has a hover provider')
	);
	export const hasDocumentHighlightProvider = new RawContextKey<boolean>(
		'editorHasDocumentHighlightProvider',
		false,
		nls.localize('editorHasDocumentHighlightProvider', 'Whether the editor has a document highlight provider')
	);
	export const hasDocumentSymbolProvider = new RawContextKey<boolean>(
		'editorHasDocumentSymbolProvider',
		false,
		nls.localize('editorHasDocumentSymbolProvider', 'Whether the editor has a document symbol provider')
	);
	export const hasReferenceProvider = new RawContextKey<boolean>(
		'editorHasReferenceProvider',
		false,
		nls.localize('editorHasReferenceProvider', 'Whether the editor has a reference provider')
	);
	export const hasRenameProvider = new RawContextKey<boolean>(
		'editorHasRenameProvider',
		false,
		nls.localize('editorHasRenameProvider', 'Whether the editor has a rename provider')
	);
	export const hasSignatureHelpProvider = new RawContextKey<boolean>(
		'editorHasSignatureHelpProvider',
		false,
		nls.localize('editorHasSignatureHelpProvider', 'Whether the editor has a signature help provider')
	);
	export const hasInlayHintsProvider = new RawContextKey<boolean>(
		'editorHasInlayHintsProvider',
		false,
		nls.localize('editorHasInlayHintsProvider', 'Whether the editor has an inline hints provider')
	);
	...
	export const hasDocumentFormattingProvider = new RawContextKey<boolean>(
		...
		false,
		nls.localize('editorHasDocumentFormattingProvider', 'Whether the editor has a document formatting provider')
	);
	...
	export const selectionHasDiagnostics = new RawContextKey<boolean>(
		...
		false,
		nls.localize('editorSelectionHasDiagnostics', 'Whether any diagnostic is present in the current editor selection')
	);
}
