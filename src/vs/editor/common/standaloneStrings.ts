...
export namespace AccessibilityHelpNLS {
	...
	export const defaultWindowTitleIncludesEditorState = nls.localize(
	...
	export const defaultWindowTitleExcludingEditorState = nls.localize(
	...
	export const toolbar = nls.localize(
		'toolbar',
	...
	export const announceCursorPosition = nls.localize(
	...
	export const focusNotifications = nls.localize(
		'focusNotifications',
