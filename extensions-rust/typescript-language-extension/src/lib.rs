...
impl CrowExtension for TypeScriptLanguageExtension {
    ...
    fn execute_command(command_id: String, args: String) -> Result<String, String> {
        match command_id.as_str() {
            "typescript.restartTsServer" => {
                let _ = host::execute_command("__crow.restartTsServer", &args);
...
fn tsserver_request(
    ...
    host::execute_command("__crow.tsserver", &payload).ok()
}
...
crow_extension_sdk::export_extension!(TypeScriptLanguageExtension);
