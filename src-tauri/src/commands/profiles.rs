...
//!
//! These commands are thin wrappers around `crow-profiles` that persist
...
use crow_profiles::{ProfileStorage, StoredProfileAssociations, StoredUserDataProfile};
use tauri::{AppHandle, Emitter, Manager};
use tokio::sync::Mutex;

pub const PROFILES_CHANGED_EVENT: &str = "crow://profiles/changed";
